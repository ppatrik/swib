...
public class DatabazovyBonusDaoTest {
    ...
    public void testAdajVsetky() {
        List<Bonus> zoznamBonusov = databazovyBonusDao.dajVsetky();
        assertEquals(POCET_BONUSOV, zoznamBonusov.size());
    }

    @Test
    public void testBpridaj() {
        List<Bonus> zoznamBonusovPov = databazovyBonusDao.dajVsetky();
    ...
    public void testCuprav() {
        ...
        zoznamBonusov = databazovyBonusDao.dajVsetky();
