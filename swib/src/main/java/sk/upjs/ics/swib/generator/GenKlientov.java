...
public class GenKlientov {
    ...
    private Set<Integer> cislaKariet;
    ...
    public GenKlientov() {
        ...
        cislaKariet = new HashSet<Integer>();
        random = new Random();
    }
    ...
    public List<Klient> generujKlientov() {
        ...
        for (int i = 0; i < muzskeMena.size(); i++) {
            ...
            klient.setCisloKarty(generujCisloKarty());
            klienti.add(klient);
        }
    ...
    private int generujCisloKarty() {
        int randomIntCK;
        do {
            randomIntCK = random.nextInt();
            if (randomIntCK < 0) {
                randomIntCK = -randomIntCK;
            }
        } while (cislaKariet.contains(randomIntCK));
        cislaKariet.add(randomIntCK);
        return randomIntCK;
    }
