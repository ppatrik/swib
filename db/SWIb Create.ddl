...
CREATE TABLE Uvery (ID int(10) NOT NULL AUTO_INCREMENT, Nazov varchar(20) NOT NULL, Bonus_naManzelku decimal(19, 4) NOT NULL, Bonus_naDieta decimal(19, 4) NOT NULL, PRIMARY KEY (ID));
